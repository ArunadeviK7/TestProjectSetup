...
class RegulationsIngestionAgent:
    ...
    def parse_documents(self, file_content, file_name):
        # Accepts a single file's content and name, returns as documents dict
...
def step_parse_documents(state):
    ...
    documents = agent.parse_documents(file_content, file_name)
...
def regulations_ingestion_workflow(file_content, file_name):
...
if __name__ == "__main__":
    print("This module is intended to be used via FastAPI backend, not as a standalone script.")
